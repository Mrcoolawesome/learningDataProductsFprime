...
#include <Test/Top/TestTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    Test::setupTopology(inputs);
    Test::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    Test::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
