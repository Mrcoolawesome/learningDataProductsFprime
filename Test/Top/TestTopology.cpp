// ======================================================================
// \title  TestTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <Test/Top/TestTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <Test/Top/TestPacketsAc.hpp>
...
// Public functions for use in main program are namespaced with deployment name Test
namespace Test {
