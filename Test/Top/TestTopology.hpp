// ======================================================================
// \title  TestTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef TEST_TESTTOPOLOGY_HPP
#define TEST_TESTTOPOLOGY_HPP
// Included for access to Test::TopologyState and Test::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <Test/Top/TestTopologyDefs.hpp>

// Remove unnecessary Test:: qualifications
 ...
 * Test::TopologyState see: TestTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Test::TopologyState see: TestTopologyDefs.hpp.
 *
